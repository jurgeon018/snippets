...
# найдем строку email
str = 'письма лично на почту a.vavilov-home@gmail.com ношу'
...
# findall
str = 'some text abc@xyz.com foo bar alice-in-chains@gmail.com, \
...
newstr = re.sub(r'([\w.-]+)@([\w.-]+)', r'\1@supermail.com', str)
print(newstr)
