...
'''
    https://github.com/hpreston/myhero_spark

python myhero_spark.py \
...
if __name__ == '__main__':
    ...
    if (bot_url == None):
        ...
        if (bot_url == None):
            bot_url = input("What is the Application Address for this Bot? ")
    ...
    if (bot_email == None):
        ...
        if (bot_email == None):
            bot_email = input("What is the Email Address for this Bot? ")
    ...
    if (app_server == None):
        ...
        if (app_server == None):
            get_app_server = input("What is the app server address? ")
    ...
    if (app_key == None):
        ...
        if (app_key == None):
            get_app_key = input("What is the app server authentication key? ")
    ...
    if (spark_token == None):
        ...
        if (spark_token == None):
            get_spark_token = input("What is the Cisco Spark Token? ")
    ...
    if (secret_key == None):
        ...
        if (secret_key == None):
            get_secret_key = input("What is the Authorization Key to Require? ")
