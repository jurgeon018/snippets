'''
https://github.com/sarupanda/webex-teams-python-bot
'''
...
def get_ngrok_url(addr='127.0.0.1', port=4040):
    try:
        print('start')
        ngrokpage = requests.get("http://{}:{}/api/tunnels".format(addr, port), headers="")
        ngrokpage = ngrokpage.text
        print('end')
    except:
...
WEBEX_TEAMS_ACCESS_TOKEN = 'NTZlNTM4MGItYTc1Zi00YzRkLWE1NzItMzM5YmU5ODEyMjFiZDAwYTJmNDQtNTcw_PF84_fc071398-50cf-465e-8a63-2b0ee5238f75'
# http://ef808eee778f.ngrok.io
